...
class EditProfile extends Component {
  ...
  signUpForm = (name, email, password) => (
    <form>
      ...
      <button onClick={this.clickSubmit} className="btn btn-raised btnEditP">
        Update
      </button>
    </form>
  );
  ...
  render() {
    ...
    return (
      <div>
        <div className="container containerEditP">
          <h2 className="textediProfile">Edit Profile</h2>
          <div
        ...
        <div className="animated">
          <img src="https://iili.io/Ky2DRR.gif" alt="Edit Profile" />
          <a className="fontanimeditP">Update your Profile</a>
        </div>
      </div>
    );
  }
